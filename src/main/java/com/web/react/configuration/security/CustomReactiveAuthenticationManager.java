...
import com.web.react.configuration.security.jwt.JwtAuthenticationToken;
import com.web.react.configuration.security.jwt.JwtPreAuthenticationToken;
import com.web.react.domain.Role;
...
public class CustomReactiveAuthenticationManager implements ReactiveAuthenticationManager {
  ...
  private Mono<Authentication> grantedGuest() {
    ...
    final JwtAuthenticationToken tokenGuest = new JwtAuthenticationToken(userName, null,
        Arrays.asList(new SimpleGrantedAuthority(Role.GUEST.name())));
